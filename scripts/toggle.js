...
TOGGLE.addEventListener("click", (evt) => {
  ...
  if(html.classList.contains("dark")) {
    ...
    bgImg.style.background = screenWidth<500 ? bgImgStyleUrl.lightMobile : bgImgStyleUrl.lightDesktop;
  } else {
    html.classList.add("dark");
    evt.target.style.background = "url(../images/icon-sun.svg) no-repeat center"
    bgImg.style.background = screenWidth<500 ? bgImgStyleUrl.darkMobile : bgImgStyleUrl.darkDesktop;
  }
});